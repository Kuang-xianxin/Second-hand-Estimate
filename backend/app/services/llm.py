...
- 商品是单独的电池、充电器、数据线、屏幕/液晶屏、镜头盖、USB盖、外壳、背带、贴膜、读卡器、内存卡、滤镜、遮光罩、电池盖、胶条胶皮、胶塞等配件
- 商品是维修零件、拆机件、主板、排线、零件、对焦齿轮、叶片驱动环、说明书、电子版
- 商品是"适用"/"适用于"/"适用机型"开头的配件销售标题
- 商品是代购/海淘类（日本mercari等平台），非国内二手现货
- 价格低于 300 元且标题/描述中不含"整机"/"相机"/"机身"/"相机机身"等明确整机词
